...
CREATE UNIQUE INDEX ALARMLIMIT_UNIQUE_KEYS ON ALARMLIMIT (UNIQUE_DEVICE_IDENTIFIER,METRIC_ID,LIMIT_TYPE);
...
CREATE INDEX FK_LIFECYCLE_ALARMLIMIT ON ALARMLIMIT_LIFECYCLE (ALARMLIMIT_ID);
ALTER TABLE ALARMLIMIT_LIFECYCLE
    ADD FOREIGN KEY (ALARMLIMIT_ID)
...
CREATE INDEX FK_ALARMLIMIT_ID ON ALARMLIMIT_SAMPLE (ALARMLIMIT_ID);
ALTER TABLE ALARMLIMIT_SAMPLE
    ADD FOREIGN KEY (ALARMLIMIT_ID)
    REFERENCES ALARMLIMIT (ALARMLIMIT_ID);
...
CREATE UNIQUE INDEX TECHNICALALER_UNIQUE_KEYS ON TECHNICALALER (UNIQUE_DEVICE_IDENTIFIER,IDENTIFIER);
...
CREATE INDEX FK_LIFECYCLE_TECHNICALALER ON TECHNICALALER_LIFECYCLE (TECHNICALALER_ID);
ALTER TABLE TECHNICALALER_LIFECYCLE
    ADD FOREIGN KEY (TECHNICALALER_ID)
...
CREATE INDEX FK_TECHNICALALER_ID ON TECHNICALALER_SAMPLE (TECHNICALALER_ID);
ALTER TABLE TECHNICALALER_SAMPLE
    ADD FOREIGN KEY (TECHNICALALER_ID)
    REFERENCES TECHNICALALER (TECHNICALALER_ID);
...
CREATE UNIQUE INDEX DEVICEIDENTIT_UNIQUE_KEYS ON DEVICEIDENTIT (UNIQUE_DEVICE_IDENTIFIER);
...
CREATE INDEX FK_LIFECYCLE_DEVICEIDENTIT ON DEVICEIDENTIT_LIFECYCLE (DEVICEIDENTIT_ID);
ALTER TABLE DEVICEIDENTIT_LIFECYCLE
    ADD FOREIGN KEY (DEVICEIDENTIT_ID)
...
CREATE INDEX FK_DEVICEIDENTIT_ID ON DEVICEIDENTIT_SAMPLE (DEVICEIDENTIT_ID);
ALTER TABLE DEVICEIDENTIT_SAMPLE
    ADD FOREIGN KEY (DEVICEIDENTIT_ID)
    REFERENCES DEVICEIDENTIT (DEVICEIDENTIT_ID);
...
CREATE UNIQUE INDEX DEVICECONNECT_UNIQUE_KEYS ON DEVICECONNECT (UNIQUE_DEVICE_IDENTIFIER);
...
CREATE INDEX FK_LIFECYCLE_DEVICECONNECT ON DEVICECONNECT_LIFECYCLE (DEVICECONNECT_ID);
ALTER TABLE DEVICECONNECT_LIFECYCLE
    ADD FOREIGN KEY (DEVICECONNECT_ID)
...
CREATE INDEX FK_DEVICECONNECT_ID ON DEVICECONNECT_SAMPLE (DEVICECONNECT_ID);
ALTER TABLE DEVICECONNECT_SAMPLE
    ADD FOREIGN KEY (DEVICECONNECT_ID)
    REFERENCES DEVICECONNECT (DEVICECONNECT_ID);
